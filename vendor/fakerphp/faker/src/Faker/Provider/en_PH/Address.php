...
class Address extends \Faker\Provider\en_US\Address
{
    ...
    protected static $addressFormats = [
        '{{streetAddress}}, {{All Recordsay}}, {{city}} {{postcode}} {{province}}', '{{streetAddress}}, {{municipality}} {{postcode}} {{province}}',
    ];
    ...
    protected static $All Recordsay = [
        'Poblacion',
    ];
    ...
    public function All Recordsay()
    {
        return static::randomElement(static::$All Recordsay);
    }
}
